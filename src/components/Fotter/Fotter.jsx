    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
          <a href="#">
            <img className="w-auto h-16" src="https://c8.alamy.com/comp/2B3J431/initial-letter-ss-logo-design-vector-template-ss-letter-logo-design-2B3J431.jpg" alt="" />
          </a>
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
          <p className="text-sm text-gray-500 dark:text-gray-300">Springdale Public School All Rights Reserved.</p>
