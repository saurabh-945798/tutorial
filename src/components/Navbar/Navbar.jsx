...
const Sidebar = () => {
  return (
    <aside className="fixed top-0 left-0 flex flex-col items-center w-16 h-screen py-8 overflow-y-auto bg-white border-r rtl:border-l rtl:border-r-0 dark:bg-gray-900 dark:border-gray-700">
