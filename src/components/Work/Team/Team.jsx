      ...
      <div className="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
        <div className="flex transition-transform transform hover:scale-105">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800">Principal</p>
          </div>
        </div>
        <div className="flex transition-transform transform hover:scale-105">
          <img
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-800">Vice Principal</p>
          </div>
        </div>
        <div className="flex transition-transform transform hover:scale-105">
          <img
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold">Emily Johnson</p>
        ...
        <div className="flex transition-transform transform hover:scale-105">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold">Michael Brown</p>
            <p className="text-sm text-gray-800">Mathematics Teacher</p>
          </div>
        </div>
        <div className="flex transition-transform transform hover:scale-105">
          <img
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold">Sophia Davis</p>
            <p className="text-sm text-gray-800">Science Teacher</p>
          </div>
        </div>
        <div className="flex transition-transform transform hover:scale-105">
          <img
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold">David Wilson</p>
            <p className="text-sm text-gray-800">Computer Science Teacher</p>
          </div>
        </div>
        <div className="flex transition-transform transform hover:scale-105">
          <img
